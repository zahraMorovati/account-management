...
public class Manager {
    ...
    int[] accountNumbers = new int[accountNUmberCount];
    ...
    public boolean checkRandomAccountNUmber(int accountNUmber, int[] array) {
    ...
    public int randomAccountNUmber() {
        ...
        if (checkRandomAccountNUmber(randomAccountNumber, accountNumbers)) {
            accountNumbers = addToArray(accountNumbers, randomAccountNumber);
